...
Navigate to `https://console.cloud.google.com/networking/networks/list?authuser=3&project={{project-id}}` to explore VPC networks on the console.
...
Navigate to `https://console.cloud.google.com/networking/firewalls/list?authuser=3&project={{project-id}}` to explore firewall rules on the console.
...
Navigate to `https://console.cloud.google.com/compute/instanceTemplates/list?authuser=3&project={{project-id}}` to explore templates on the console.

Navigate to `https://console.cloud.google.com/compute/instanceGroups/list?authuser=3&project={{project-id}}` to explore managed instance groups on the console.
...
Navigate to `https://console.cloud.google.com/compute/instances?authuser=3&project={{project-id}}` to explore virtual machine instances on the console.
...
Navigate to `https://console.cloud.google.com/security/iap?authuser=3&project={{project-id}}` to explore Identity Aware Proxy configuration.
